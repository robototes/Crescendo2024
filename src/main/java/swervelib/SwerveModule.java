...
public class SwerveModule {
	...
	public SwerveModule(
		...
		angleMotor.setCurrentLimit(configuration.physicalCharacteristics.angleMotorStatorLimit, configuration.physicalCharacteristics.angleMotorSupplyLimit);
		driveMotor.setCurrentLimit(configuration.physicalCharacteristics.driveMotorStatorLimit, configuration.physicalCharacteristics.driveMotorSupplyLimit);
