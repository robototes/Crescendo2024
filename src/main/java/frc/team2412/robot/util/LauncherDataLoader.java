...
public class LauncherDataLoader {
    ...
    public static InterpolatingTreeMap<Double, LauncherDataPoint> fromCSV(Path path) {
        ...
        try {
            ...
            BufferedWriter debugWriter = Files.newBufferedWriter(FileSystems.getDefault().getPath(Filesystem.getDeployDirectory().getPath(), "CSVInterpreter.log"));
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    debug.accept("Identified data! DISTANCE: " + distance + " ANGLE: " + angle + " RPM " + RPM);
