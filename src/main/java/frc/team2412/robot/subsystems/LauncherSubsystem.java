...
public class LauncherSubsystem extends SubsystemBase {
	...
	private final ArmFeedforward launcherAngleFF = new ArmFeedforward(0.1, 0.1, 0);
	...
	public void setAngle(double launcherAngle) {
		...
		launcherAngleOnePIDController.setReference(
				...
				0,
				launcherAngleFF.calculate(Units.degreesToRadians(launcherAngle - FF_PIVOT_OFFSET), 0));
